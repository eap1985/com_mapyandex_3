...
class MapYandexControllerMapYandexRoute extends MapYandexController
{
	/**
	...
	function add()
	{
		...
		JRequest::setVar( 'view', 'mapyandexroute' );
	...
	function save()
	{
		...
		$model = $this->getModel('mapyandexroute');
	...
	function apply()
	{
		...
		$link = 'index.php?option=com_mapyandex&view=mapyandexroute&layout=form&id='. $id;
		$this->setRedirect($link, $msg);
	...
	function remove()
	{
		...
		$this->setRedirect( 'index.php?option=com_mapyandex&view=mapyandexroute', $msg );
	}
