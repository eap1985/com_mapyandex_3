 ...
 * @copyright 2007-2011
  ...
  **/
	...
	require_once mapyandexWideImage::path() . 'Exception.php';
	
	require_once mapyandexWideImage::path() . 'Image.php';
	require_once mapyandexWideImage::path() . 'TrueColorImage.php';
	require_once mapyandexWideImage::path() . 'PaletteImage.php';
	
	require_once mapyandexWideImage::path() . 'Coordinate.php';
	require_once mapyandexWideImage::path() . 'Canvas.php';
	require_once mapyandexWideImage::path() . 'MapperFactory.php';
	require_once mapyandexWideImage::path() . 'OperationFactory.php';
	
	require_once mapyandexWideImage::path() . 'Font/TTF.php';
	require_once mapyandexWideImage::path() . 'Font/GDF.php';
	require_once mapyandexWideImage::path() . 'Font/PS.php';
	...
	class mapyandexWideImage
	{
		...
		static function load($source)
		{
			...
			return call_user_func(array('mapyandexWideImage', 'loadFrom' . $predictedSourceType), $source);
		}
	...
	mapyandexWideImage::checkGD();
	
	mapyandexWideImage::registerCustomMapper('WideImage_Mapper_BMP', 'image/bmp', 'bmp');
	mapyandexWideImage::registerCustomMapper('WideImage_Mapper_TGA', 'image/tga', 'tga');
